...
namespace HoloToolkit.Unity.InputModule
{
    ...
    /// </summary>
    public class InitialDragStop : MonoBehaviour, IFocusable, IInputHandler, ISourceStateHandler
    {
        /// <summary>
        /// Event triggered when dragging starts.
        /// </summary>
        private event Action StartedDragging;

        /// <summary>
        /// Event triggered when dragging stops.
        /// </summary>
        private event Action StoppedDragging;
        ...
        private bool stillDragable = true;
        ...
        private void Update()
        {
            if (stillDragable == false)
            {
                Destroy(this.thisCollider);
                Destroy(this);
                return;
            }
